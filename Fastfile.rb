...
platform :ios do
  ...
  def register_app do 
    produce(
      username: "burak.kelleroglu@vngrs.com",
      app_identifier: "com.vngrs.example",
      app_name: "Vngrs Rocks !",
      team_name: "Burak Kelleroglu",
      itc_team_name: "vngrs",
      company_name: "VNGRS"  
    )
    end
  ...
  lane :release do |options|
    ...
    message = "Successfully deployed new App Update. Version: - #{current_version_string}"
